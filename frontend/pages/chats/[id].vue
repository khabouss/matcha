...
<template>
    <div class="chat-page">
      ...
      <div class="messages">
        <div v-for="message in chat.messages" :key="message.id" :class="message.isSentByMe ? 'message-sent' : 'message-received'" class="message">
          <p>{{ message.text }}</p>
        </div>
      </div>
