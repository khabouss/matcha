    ...
    <div>
        ...
        <div class="actions">
            <div class="unmatch" v-if="props.profile.isMatch">
                ...
                <svg viewBox="0 0 24 24" width="30px" height="30px" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <path d="M12 6L10 9.99995L14 11L12 14" stroke="#f27d7d" stroke-width="2" stroke-linecap="round"
                ...
                <svg viewBox="0 0 24 24" width="30px" height="30px" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <path
                            ...
                            stroke="#f27d7d" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    </g>
                </svg>
            </div>
            ...
            <div class="unmatch" v-if="props.profile.isMatch">
                ...
                <svg width="30px" height="30px" viewBox="-7.14 -7.14 35.28 35.28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>report_flag [#1420]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-59.000000, -640.000000)" fill="#f27d7d"> <g id="icons" transform="translate(56.000000, 160.000000)"> <path d="M7.2,492 L24,492 L24,480 L7.2,480 L7.2,492 Z M3,500 L5.1,500 L5.1,480 L3,480 L3,500 Z" id="report_flag-[#1420]"> </path> </g> </g> </g> </g></svg>
            </div>
        </div>
    </div>
</template>
